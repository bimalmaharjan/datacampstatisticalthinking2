...
from  statisticalthinkingpart1 import empiricalcumulativedistribution as ecdf
...
rain_july= [  66.2,   39.7,   76.4,   26.5,   11.2,   61.8,    6.1,   48.4,
...
for _ in range(50):
    ...
    # Compute ECDFs
    x_1, y_1 = ecdf.ecdf(perm_sample_1)
    x_2, y_2 = ecdf.ecdf(perm_sample_2)
...
x_1, y_1 = ecdf.ecdf(rain_july)
x_2, y_2 = ecdf.ecdf(rain_november)
